...
sys.path.insert(0, '../../project/AI-Poker-Agent/pypokerengine/api/')
import game
...
def testperf(agent_name1, agent1, agent_name2, agent2):		
    ...
    for game in range(1, num_game+1):
        ...
        print(f"Game {game:3}: {agent_name1} stack: {game_result['players'][0]['stack']:6} | {agent_name2} stack: {game_result['players'][1]['stack']:6}, {agent_name1} pot: {agent1_pot:8}, {agent_name2} pot: {agent2_pot:8}")
...
def parse_arguments():
    ...
    parser.add_argument('-n1', '--agent_name1', help="Name of agent 1", default="RandomPlayer", type=str)
    parser.add_argument('-a1', '--agent1', help="Agent 1", default=RandomPlayer())    
    parser.add_argument('-n2', '--agent_name2', help="Name of agent 2", default="RaisedPlayer", type=str)
